...
<main class="container">
  ...
  <div class="card-body">
    <h5 class="card-title"><?php echo mb_strimwidth ($dspro ['pronome'],0,70,"..."); ?></h5>
    <p class="card-text"><?php echo mb_strimwidth ($dspro ['prodescricao'],0,130,"..."); ?></p>
    <p class="text-danger">Valor:<b>R$ <?php echo mb_strimwidth ($dspro['provalorvenda'],0,20,"..."); ?></b></p>
    <p class="text-primary">Estoque: <?php echo mb_strimwidth ($dspro ['proquantidade'],0,30,"..."); ?></p>
